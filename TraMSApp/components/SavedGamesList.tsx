 ...
 */
function SavedGamesList({navigation}: SavedGamesListProps) {
     ...
     * @param {Game} item 
     */
    async function onLoadGame(item: Game) {
    ...
    return <FlatList style={styles.list} data={loadedGames} keyExtractor={(item: Game) => item.companyName} renderItem={({item}) => <TouchableOpacity style={styles.button} onPress={onLoadGame.bind(null, item)}>
