...
export class VehicleResponse {
     ...
     */
    public standingCapacity: number = 0;
     ...
     */
    public delayInMinutes: number = 0;
     ...
     */
    public nextInspectionDueInDays: number = 0;

    /**
     * The additional type information map.
     */
    public additionalTypeInformationMap: AdditionalTypeInformation = new AdditionalTypeInformation();
