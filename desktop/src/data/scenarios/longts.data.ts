...
const SUPPLIED_VEHICLES = [new SuppliedVehicles("BUS", new VehicleModel("MyBus Single Decker", 'Single Decker Bus',44, 36, 85000.0, 'assets/Bus.jpg'), 2)];
...
const REGISTRATION_SHORT_CODE = "LNT";
