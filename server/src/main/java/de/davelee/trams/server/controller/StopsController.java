...
import de.davelee.trams.server.response.StopResponse;
...
/**
 * This class provides REST endpoints which provide operations associated with stops in the TraMS Server API.
 * @author Dave Lee
 */
@RestController
@Tag(name="/api/stops")
