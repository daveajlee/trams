...
/**
 * This class provides REST endpoints which provide operations associated with a single vehicle in the TraMS Server API.
 * @author Dave Lee
 */
@RestController
...
public class VehicleController {
    ...
    public ResponseEntity<Void> addHoursForDate (@RequestBody AddVehicleHoursRequest addVehicleHoursRequest) {
        ...
        return vehicleService.addHoursForDate(vehicles.get(0), addVehicleHoursRequest.getHours(), DateUtils.convertDateToLocalDateTime(addVehicleHoursRequest.getDate())) ?
