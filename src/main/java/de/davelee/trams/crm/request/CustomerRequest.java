...
/**
 * This class is part of the PersonalMan REST API. It represents a request to add the following customer to the server
 * containing title, first name, last name, email address, telephone number and address.
 * @author Dave Lee
 */
@Builder
@Getter
