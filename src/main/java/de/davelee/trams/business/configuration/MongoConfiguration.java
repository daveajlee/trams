...
/**
 * Configure the mongo database which is used to store all data in Trams Business.
 * @author Dave Lee
 */
@Configuration
@EnableMongoRepositories(basePackages = "de.davelee.trams.business.repository")
